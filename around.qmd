...
function addGeoJSONToMap(geoJSON, map, pointsWithin) {
    L.geoJSON(geoJSON, {
        ...
        onEachFeature: function(feature, layer) {
            ...
            layer.on({
              click: (event) => {
                // const id = event.target.feature.properties.url.replace(".gpx", "") ;
            ...
            // Optional: Add a mouseover effect to highlight the polyline
