...
<form class="form-language-switcher">
  <input value="Français 🇫🇷" type="button" name="stop" id="button_french" class="button_lang current_lang">
  <input value="English 🇬🇧🇺🇸" type="button" name="start" id="button_english" class="button_lang">
</form>
`
buttons.value = "fr"
