...
```{ojs}
function popUpSummit(feature, lang, bigscreen){
...
` 
  ...
  const popupsmall = `
    <table>
      <tr>
        <td><b>${AscentName}</b>:</td>
        <td>${feature.properties.nom}</td>
      </tr>
      <tr>
        <td><b>${departure}</b>:</td>
        <td>${feature.properties.depart} (${feature.properties.massif})</td>
      </tr>
      <tr>
        <td><b>${maxAlt}</b>:</td>
      ...
      <tr>
        <td><b>${climbLength}</b>:</td>
        <td>${feature.properties.longueur}km</td>
      </tr>
      <tr>
        <td><b>${gain}</b>:</td>
        <td>${feature.properties.denivellation}m (${feature.properties.category})</td>
      </tr>
      <tr>
        <td><b>${averageSlope}</b>:</td>
        <td>${feature.properties.percent_moyen}%</td>
      </tr>
      <tr>
        <td><b>${maxSlope}</b>:</td>
        <td>${feature.properties.percent_maximal}%</td>
      </tr>
      <tr>
        <td colspan="2">
          <a href="${feature.properties.href}" target="_blank">${hrefText} <code>https://cols-cyclisme.com/</code></a>
